                    ...
                    <div className="p-6 space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-surface-container-lowest border border-slate-800 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-sky-500 transition-all text-on-surface"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <select
                                ...
                                className="w-full bg-surface-container-lowest border border-slate-800 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-sky-500 text-on-surface appearance-none"
                            >
